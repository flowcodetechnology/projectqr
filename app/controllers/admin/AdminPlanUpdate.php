    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['color'] = !verify_hex_color($_POST['color']) ? null : $_POST['color'];
                ...
                'flipbooks_limit' => (int) ($_POST['flipbooks_limit'] ?? 0),
                'flipbooks_file_size_limit' => (float) ($_POST['flipbooks_file_size_limit'] ?? 10),
                'flipbook_custom_branding' => isset($_POST['flipbook_custom_branding']),
                'domains_limit' => (int) $_POST['domains_limit'],
                'payment_processors_limit' => (int) ($_POST['payment_processors_limit'] ?? 0),
                'signatures_limit' => (int) ($_POST['signatures_limit'] ?? 0),
                'teams_limit' => (int) ($_POST['teams_limit'] ?? 0),
                'team_members_limit' => (int) ($_POST['team_members_limit'] ?? 0),
                'affiliate_commission_percentage' => (int) ($_POST['affiliate_commission_percentage'] ?? 0),
                ...
                'documents_model'                   => $_POST['documents_model'] ?? 'gpt-3.5-turbo',
                'documents_per_month_limit'         => (int) ($_POST['documents_per_month_limit'] ?? 0),
                'words_per_month_limit'             => (int) ($_POST['words_per_month_limit'] ?? 0),
                'images_api'                        => $_POST['images_api'] ?? 'dall-e-2',
                'images_per_month_limit'            => (int) ($_POST['images_per_month_limit'] ?? 0),
                'transcriptions_per_month_limit'    => (int) ($_POST['transcriptions_per_month_limit'] ?? 0),
                'transcriptions_file_size_limit'    => (float) ($_POST['transcriptions_file_size_limit'] ?? 25) > get_max_upload() || (float) ($_POST['transcriptions_file_size_limit'] ?? 25) < 0 || (float) ($_POST['transcriptions_file_size_limit'] ?? 25) > 25 ? (get_max_upload() > 25 ? 25 : get_max_upload()) : (float) ($_POST['transcriptions_file_size_limit'] ?? 25),
                'chats_model'                       => $_POST['chats_model'] ?? 'gpt-3.5-turbo',
                'chats_per_month_limit'             => (int) ($_POST['chats_per_month_limit'] ?? 0),
                'chat_messages_per_chat_limit'      => (int) ($_POST['chat_messages_per_chat_limit'] ?? 0),
                'chat_image_size_limit'    => (float) ($_POST['chat_image_size_limit'] ?? 20) > get_max_upload() || (float) ($_POST['chat_image_size_limit'] ?? 20) < 0 || (float) ($_POST['chat_image_size_limit'] ?? 20) > 20 ? (get_max_upload() > 20 ? 20 : get_max_upload()) : (float) ($_POST['chat_image_size_limit'] ?? 20),
                'syntheses_api'                     => $_POST['syntheses_api'] ?? 'aws',
                'syntheses_per_month_limit'         => (int) ($_POST['syntheses_per_month_limit'] ?? 0),
                'synthesized_characters_per_month_limit' => (int) ($_POST['synthesized_characters_per_month_limit'] ?? 0),
